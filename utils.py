...
def current_weather(lat, lon):
    ...
    """
    token = '2e0527b0-1767-497d-90d4-82750a738181'  # Вставить ваш токен
    ...
    result = {
        ...
        'pressure': (data['fact']['pressure_mm'], data['fact']['pressure_pa']),  # TODO Реализовать вычисление давления из данных полученных от API
