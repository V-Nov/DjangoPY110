...
from store.views import products_view, shop_view, products_page_view, cart_view, cart_add_view, cart_del_view, \
...
urlpatterns = [
    ...
    path('cart/add/<str:id_product>', cart_add_view, name="cart_add_view"),
